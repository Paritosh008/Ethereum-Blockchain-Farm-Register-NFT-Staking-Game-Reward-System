...
contract FactoryERC1155 {
    ...
    mapping(address => uint256) public contractToIndex; // contract address to index mapping
    ...
    */
    function mintERC1155(uint _index, string memory _name, uint256 amount) public {
        require(msg.sender == indexToOwner[_index], "Not an owner of the collection");
        tokens[_index].addNameAndId(_name);
    ...
    */
    ...
    function getCurrentTokenIndex() public view returns (uint){
